  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-24">
        <ScrollReveal>
          <div className="glass-card rounded-2xl p-10 sm:p-14 text-center max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-light/60 border border-accent/20 mb-6">
              ...
              <span className="text-xs font-mono text-accent-dark tracking-wider">
                GET IN TOUCH
              </span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
              お気軽にご連絡ください<span className="text-accent">.</span>
            </h2>
            <p className="text-base text-muted leading-relaxed max-w-md mx-auto mb-8">
              新しいプロジェクトやお仕事のご相談をお待ちしております。
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 border-2 border-border rounded-xl text-sm font-semibold text-foreground hover:border-accent hover:text-accent transition-colors"
              >
